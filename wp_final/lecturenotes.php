...
<head>
  ...
  <body>
    ...
    <div class="tabs">
      <button type="button" name="read" class="active" id="left-tab" onclick="readTab()">Lectures</button>
    ...
    <div id="read" class="content">
      ...
      $sql = "SELECT * FROM lectures ORDER BY id DESC";
    ...
    <div id="write" class="content hidden">
      ...
      <form name="form" method="post" action="upload_lecture.php" enctype="multipart/form-data" >
