...
<head>
  ...
  <body>
    ...
    <div class="tabs">
      <button type="button" name="read" class="active" id="left-tab" onclick="readTab()">Labs</button>
    ...
    <div id="write" class="content hidden">
      ...
      <form name="form" method="post" action="upload_lab.php" enctype="multipart/form-data" >
